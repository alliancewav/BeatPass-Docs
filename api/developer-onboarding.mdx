...
<Note>
  Tokens are obtained via login and should be stored securely. Never expose tokens in client-side code or version control.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Error Catalog" icon="triangle-exclamation" href="/api/error-catalog">
