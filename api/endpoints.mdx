...
<Note>
  Keep the connection open to receive notifications. Reconnect with exponential backoff if disconnected.
</Note>
...
<Note>
  Radio endpoints generate track recommendations based on seed content. These are internal recommendation algorithms.
</Note>
...
| Type | Description |
|------|-------------|
| `track` | Recommendations similar to a track |
| `artist` | Recommendations from/similar to an artist |
| `genre` | Recommendations within a genre |
