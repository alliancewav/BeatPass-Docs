...
Your current session is clearly marked, usually with a badge or label saying **"Current Device"** or **"This Device"**. This helps you distinguish between the session you're using now and other active sessions.
...
1. Go to **Settings** → **Account** → **Active Sessions**
2. Find the **"Log Out Other Devices"** button
3. Enter your password to confirm
4. All sessions except your current one will be ended
