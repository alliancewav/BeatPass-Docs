...
<Steps>
  ...
  <Step title="Click 'Forgot Password'">
    Look for the **Forgot Password** or **Reset Password** link below the login form.
  </Step>
...
<Note>
  The reset email comes from BeatPass. Add our email address to your contacts to prevent filtering.
</Note>
