...
<Steps>
  <Step title="Go to API Settings">
    Navigate to **Settings** → **Account** → **Developer API** or **Access Tokens**.
  </Step>
...
1. Go to **Settings** → **Account** → **Developer API**
...
- Review authentication requirements in [Getting Started](/developers/guides/getting-started)
