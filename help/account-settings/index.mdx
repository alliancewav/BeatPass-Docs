...
canonical: "https://docs.beatpass.ca/help/account-settings"
---
...
<Tabs>
  <Tab title="Desktop">
    <Frame caption="Account Settings navigation on desktop in light mode">
      <img src="/assets/screenshots/account-settings-desktop-light.png" alt="Account Settings page with navigation for account details, social login, password, two-factor authentication, sessions, language, developers, and account deletion" />
    </Frame>
  </Tab>
  <Tab title="Mobile">
    <Frame caption="Account Settings heading on mobile in dark mode">
      <img src="/assets/screenshots/account-settings-mobile-dark.png" alt="Mobile Account Settings page in dark mode" />
    </Frame>
  </Tab>
</Tabs>
...
2. Select **Settings** from the menu. The page heading is **Account Settings**.
...
<Tabs>
  ...
  <Tab title="Advanced">
    <Columns cols={2}>
      ...
      <Card title="Delete Account" icon="trash-can">
