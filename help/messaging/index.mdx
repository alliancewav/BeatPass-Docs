...
canonical: "https://docs.beatpass.ca/help/messaging"
---
...
<Tabs>
  <Tab title="Desktop">
    <Frame caption="Messaging entry point on desktop in light mode">
      <img src="/assets/screenshots/messaging-desktop-light.png" alt="Your Messages screen explaining how to open the messaging panel from the header" />
    </Frame>
  </Tab>
  <Tab title="Mobile">
    <Frame caption="Messaging entry point on mobile in dark mode">
      <img src="/assets/screenshots/messaging-mobile-dark.png" alt="Mobile Your Messages screen with the message icon visible in the header" />
    </Frame>
  </Tab>
</Tabs>
