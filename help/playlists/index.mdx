...
canonical: "https://docs.beatpass.ca/help/playlists"
---
...
<Tabs>
  <Tab title="Desktop">
    <Frame caption="My playlists on desktop in light mode">
      <img src="/assets/screenshots/playlists-desktop-light.png" alt="My playlists page with playlist search and an empty-library message on desktop" />
    </Frame>
  </Tab>
  <Tab title="Mobile">
    <Frame caption="My playlists on mobile in dark mode">
      <img src="/assets/screenshots/playlists-mobile-dark.png" alt="Mobile My playlists page with create, search, and sort controls" />
    </Frame>
  </Tab>
</Tabs>
