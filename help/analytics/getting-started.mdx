...
canonical: "https://docs.beatpass.ca/help/analytics/getting-started"
---
...
<Tip>
  On desktop, approved producers can open **Insights** from the top navigation bar to go directly to their primary artist's Insights page.
</Tip>
