...
When setup is incomplete, BeatPass shows the action needed for that producer profile. You may see **Set up BEATPAY** for bank payouts powered by Wise or **Connect Stripe Account Now** when Stripe is the route available to your account.
...
| **Held** | Waiting for review before the payout can move |
