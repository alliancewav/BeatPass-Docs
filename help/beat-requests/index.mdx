...
### As a Producer (Verified)

To submit beats to requests, you need:
- A **producer profile** on BeatPass
- **Verified status** to receive notifications about new requests
- At least one **uploaded track** to submit

<Info>
  All users can view beat requests, but only verified producers receive notifications when new requests are posted.
</Info>
