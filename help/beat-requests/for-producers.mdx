...
- **Upload permission** — The `music.create` permission on your account

### Verified vs. Non-Verified Producers

| Feature | Non-Verified | Verified |
|---------|--------------|----------|
| View active requests | ✓ | ✓ |
| Submit beats to requests | ✓ | ✓ |
| Receive notifications for new requests | — | ✓ |

<Info>
  Verified producers receive automatic notifications when new beat requests are posted, helping you respond quickly to opportunities.
</Info>
...
Verified producers receive notifications for new beat requests:
...
2. Find **Beat Requests** → **Matching Requests**
3. Toggle on/off for each notification channel

<Note>
  Only verified producers see the "Matching Requests" notification option. Apply for verification to unlock this feature.
</Note>
