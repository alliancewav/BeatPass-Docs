...
description: "Browse active Beat Requests, understand who can submit, and learn the rules for sending beats to requesters."
canonical: "https://docs.beatpass.ca/help/beat-requests/for-producers"
---
...
- **Push notifications** — If enabled in your settings
...
4. Toggle on/off for each channel (Email, Push, In-App)
...
<AccordionGroup>
  <Accordion title="Do I need to create new beats for requests?">
    Not necessarily. You can send tracks that already exist in your BeatPass catalog, or use **Upload New** to upload a fresh beat and auto-submit it to the request.
  </Accordion>
  
  <Accordion title="What if they want to buy exclusive rights?">
    If the requester includes a budget and wants exclusive rights, that negotiation happens directly between you and them via messaging. BeatPass handles standard and exclusive licensing through the normal track-licensing flow.
  </Accordion>
  ...
  <Accordion title="How do I become verified?">
    Verification happens through Discord. Visit the Producer Program section in Backstage to find the **Verify Through Discord** option.
  </Accordion>
</AccordionGroup>
...
<Columns cols={2}>
  <Card title="Uploading Beats" icon="cloud-arrow-up" href="/help/uploading">
