...
canonical: "https://docs.beatpass.ca/help/beat-requests/managing-requests"
---
...
| Status | Meaning |
|--------|---------|
| **Active** | Still accepting submissions (countdown timer shown on the card) |
| **Expired** | No longer accepting submissions |

Expired requests that are within the 30-day renewal window show a **Renew (1 token)** button.
...
| Event | What Happens |
|-------|-------------|
| **Token consumed** | Request is created and goes live |
| **Duration ends** | Request expires automatically |
| **You delete it (below cap)** | Token is refunded |
| **You delete it (at cap)** | No refund |
| **You renew it** | 1 token consumed, request reactivated for original duration |
