...
canonical: "https://docs.beatpass.ca/help/uploading/creating-albums"
---
...
Create a collection directly from **My Collections**. You can also turn on **Create collection** while uploading multiple beats:

<Steps>
  <Step title="Open My Collections">
    Click your **profile avatar**, select **Backstage**, then open **My Collections**.
  </Step>
  <Step title="Create the collection">
    Select **Create collection**. Add the beats that belong to this release in the collection editor.
  </Step>
