...
sidebarTitle: "Payout Eligibility"
canonical: "https://docs.beatpass.ca/help/earnings/payout-eligibility"
---
...
1. The excluded split does not appear as an earning in **Finance activity**
...
<Steps>
  ...
  <Step title="Check the dashboard state">
    Read the **Payout setup** state and follow an action only when one appears.
  </Step>
  <Step title="Review warnings and statuses">
    Look for signals such as **Payout setup needs attention**, **Needs attention**, or any prompt asking for more information.
  </Step>
</Steps>
...
1. Open **Finances**
2. Select **Set up bank payouts**
3. Choose a bank account currency that your bank can receive and provide the requested bank details
...
<AccordionGroup>
  ...
  <Accordion title="Why does a subscription earning need attention?">
    Open **Finance activity** and review the affected subscription earning. **Needs attention** means an earning exists but its payout failed or is on hold. A split excluded before it became an earning does not appear in this list.
  </Accordion>
