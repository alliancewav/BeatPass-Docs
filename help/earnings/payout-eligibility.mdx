...
<CardGroup cols={2}>
  ...
  <Card title="Stripe Connect" icon="credit-card">
    Stripe Connect remains active for producers already using Stripe and for producers not yet included in the BEATPAY rollout.
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Can I still earn before setup is finished?">
    Activity can still happen, but you are not safely payout-ready until your payout setup is complete.
  </Accordion>
