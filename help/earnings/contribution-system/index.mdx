...
sidebarTitle: "Contribution System"
canonical: "https://docs.beatpass.ca/help/earnings/contribution-system"
---
...
Subscription payout systems can be confusing if a platform only says "fair revenue share." BeatPass publishes the contribution logic so producers can understand what affects their share: recency, plays, and collaborator count.

The formula does not guarantee a fixed payout. It explains how contribution value is calculated.
...
BeatPass recalculates contribution values periodically (roughly every few hours) so new plays and time decay continue to affect upcoming payout calculations.
