...
<Steps>
  ...
  <Step title="Receive payouts through the active route">
    Once funds are eligible to move, BeatPass sends them through the active payout route for your producer account.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="BEATPAY Bank Payouts" href="/help/earnings/beatpay" icon="money-bill-transfer">
    Set up BEATPAY, review bank payout statuses, and understand rollout behavior.
  </Card>
