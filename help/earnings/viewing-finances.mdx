...
- **Set up BEATPAY** when Wise-powered bank payouts are available to your account
- **Connect Stripe Account Now** when Stripe Connect is the available route
...
- Follow **Set up BEATPAY** or **Connect Stripe Account Now** based on the setup shown in your account
...
<AccordionGroup>
  <Accordion title="Why do I still see setup messaging after connecting a payout account?">
    BeatPass can stay in setup mode until the active payout provider fully enables your account. Return to **Finances** and complete any remaining prompts.
  </Accordion>
