...
canonical: "https://docs.beatpass.ca/help/billing/payment-methods"
---
...
<Columns cols={2}>
  <Card title="Supported Methods" icon="credit-card" href="/help/billing/payment-methods">
    See what payment options are available.
  </Card>
  <Card title="Adding a Payment Method" icon="plus" href="/help/billing/payment-methods">
    Learn how your first card is usually saved during checkout.
  </Card>
  <Card title="Updating Payment Method" icon="arrows-rotate" href="/help/billing/payment-methods">
