...
<AccordionGroup>
  <Accordion title="What happens when I buy exclusive?" icon="crown" defaultOpen>
    BeatPass completes the secure payment, generates the exclusive license, marks the track as sold, prepares the original WAV download, and stores the license in **Your library** → **Licenses**.
  </Accordion>
