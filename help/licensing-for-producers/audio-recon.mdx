...
canonical: "https://docs.beatpass.ca/help/licensing-for-producers/audio-recon"
---
...
## Audio Recon is not a beat-finder for copying sounds

Audio Recon is a producer protection and review tool. It detects high-similarity matches so credited producers can review possible uses of their beats.

It is not a permission system, not a claim that a match is infringement, and not a tool for artists to clone another producer's sound.
...
<Columns cols={2}>
  ...
  <Card title="Public Verification" icon="shield-halved" href="/help/downloads-and-licensing/verifying-licenses">
    Confirm whether a license certificate is currently active.
  </Card>
  <Card title="BeatPassID" icon="fingerprint" href="/help/downloads-and-licensing/beatpass-id">
    Understand the fingerprint details that support certificate tools.
  </Card>
  <Card title="Trust Stack" icon="layer-group" href="/help/getting-started/beatpass-trust-stack">
    See how protection review fits into BeatPass's proof system.
  </Card>
</Columns>
