...
status: "published"
related: ["3.1.6"]
sidebarTitle: "Upload Flow Refresh, Collection Cards & Carousel Fixes"
description: "Release notes for Upload Flow Refresh, Collection Cards & Carousel Fixes."
canonical: "https://docs.beatpass.ca/release-notes/v3.0/3.1.7"
---
...
- **Dynamic color tinting** — Cards pick up a subtle tint from the cover art in both light and dark themes, with a neutral fallback if extraction fails or is blocked.
