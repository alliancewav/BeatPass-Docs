...
status: "published"
related: []
sidebarTitle: "Beat Request Overhaul & Platform Polish"
description: "Release notes for Beat Request Overhaul & Platform Polish."
canonical: "https://docs.beatpass.ca/release-notes/v3.0/3.0.9"
---
...
- **Routing fix** — Statistics and duration-tier pages no longer load the wrong content
- **Submitted tracks view** — Request owners can now view submitted tracks directly (track name, producer name, and time)
