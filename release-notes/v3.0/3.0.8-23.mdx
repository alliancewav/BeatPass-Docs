...
sidebarTitle: "Email & Notification Improvements, Payment Recovery, and Social Engagement"
canonical: "https://docs.beatpass.ca/release-notes/v3.0/3.0.8-23"
---
...
- **Safe retries** — Clicking "Retry" multiple times won't create duplicate charges
...
- **Overload protection** — Prevents accidental spam-clicking
...
- Fixed an error when viewing invoice details
