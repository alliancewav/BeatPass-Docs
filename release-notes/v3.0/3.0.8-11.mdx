...
components: ["producer-dashboard", "upload", "channels", "admin"]
---
...
**Issue:** Adding existing tracks to an album created duplicates of those tracks instead of associating the existing tracks.
