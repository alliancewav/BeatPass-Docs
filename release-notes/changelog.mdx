...
<Update label="February 20, 2026" description="v3.1.0" tags={["Feature", "Producer", "Notifications"]}>
  ## Beat Placement Detection

  BeatPass now automatically detects when your beats are used in songs on Spotify, YouTube, and Deezer — and notifies you with full details.
  ...
  - **Heard In section** — New producer-only section on track pages showing detected placements with confidence scores and streaming links
  - **Placement notifications** — In-app and email alerts with song details, streaming buttons, and verification guidance
  - **Collaborative beat support** — All credited producers are notified, even if only one has a verified profile
  - **License verification guidance** — Each notification explains how to confirm whether the placement is a licensed use
