...
audience: "developers"
canonical: "https://docs.beatpass.ca/developers/auth"
---
...
<Tabs>
  ...
  <Tab title="Token (Bearer Auth)">
    ...
    **Album:** `plays`, `created_at`, `tracks` relation.
    ...
    Sensitive fields remain hidden even with authentication, including audio source URLs, internal ownership references, licensing configuration, and processing metadata.
  </Tab>
</Tabs>
