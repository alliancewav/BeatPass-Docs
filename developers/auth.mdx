...
```
localhost, localhost:3000, 127.0.0.1, open.beatpass.ca
```
...
Many endpoints use `optionalAuth:sanctum` middleware—they work without authentication but return more data when authenticated:
...
|--------|---------|----------|
| 401 | Unauthenticated | Session missing, invalid, or expired |
