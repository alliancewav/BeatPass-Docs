...
audience: "developers"
canonical: "https://docs.beatpass.ca/developers/error-catalog"
---
...
<Columns cols={4}>
  <Card title="400" icon="circle-exclamation">
  ...
  <Card title="404" icon="magnifying-glass">
    **Not Found** Doesn't exist
  </Card>
  <Card title="409" icon="arrows-split-up-and-left">
    **Conflict** State conflict
  </Card>
  <Card title="422" icon="file-circle-xmark">
    **Unprocessable** Validation failed
  </Card>
  <Card title="429" icon="gauge-high">
    **Too Many** Rate limited
  </Card>
  <Card title="500" icon="server">
...
<Tabs>
  <Tab title="Upload Validation">
    <AccordionGroup>
      ...
      <Accordion title="Invalid file format" icon="file-audio">
        ...
        **Resolution:** Upload a WAV file. MP3, FLAC, AIFF, and other formats are not accepted by the current upload flow.
      </Accordion>
  ...
  <Tab title="Processing">
    <AccordionGroup>
      <Accordion title="Transcode failed" icon="triangle-exclamation">
...
<Columns cols={2}>
  ...
  <Card title="Check Headers" icon="code">
    Monitor `X-RateLimit-Remaining` before making requests.
  </Card>
  <Card title="Queue Requests" icon="list-check">
...
<AccordionGroup>
  ...
  <Accordion title="504 - Gateway Timeout" icon="hourglass-half">
    <Badge color="gray">504</Badge>
