...
| Category | Endpoint Type | TTL | Notes |
|----------|--------------|-----|-------|
| **Analytics** | Dashboard overview | 15 min | Producer dashboard stats |
| **Analytics** | Real-time metrics | 1 min | Live engagement data |
| **Leaderboards** | Global rankings | 5 min | All leaderboard types |
| **Content** | Track/Album details | 30 min | Metadata and images |
| **User** | Profile data | 1 hour | User settings, preferences |
| **Contribution** | Track values | 24 hours | Contribution calculations |
