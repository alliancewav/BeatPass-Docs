...
audience: "developers"
canonical: "https://docs.beatpass.ca/developers/overview"
---
...
Paginated endpoints use <Tooltip tip="A pagination method that uses current_page, last_page, and per_page values to move through large result sets.">page-number pagination</Tooltip>:
