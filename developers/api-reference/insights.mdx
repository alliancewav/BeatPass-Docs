...
description: "Analytics and insights endpoints for tracks, albums, and artists"
---
...
const response = await fetch('/api/v1/insights/tracks/123', {
  credentials: 'include',
...
| `POST /content-analytics/export/csv` | `POST /insights/export/csv` |
