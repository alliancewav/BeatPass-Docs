...
| API | Description |
|-----|-------------|
| [Dashboard API](/developers/api-reference/dashboard) | Producer dashboard metrics, track performance, and upload insights |
| [Insights API](/developers/api-reference/insights) | Analytics and insights for tracks, albums, and artists |
...
| **Insights** | Analytics and insights for content | Required |
